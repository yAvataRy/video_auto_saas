...
export type SchedulingStatusType = typeof SchedulingStatus[keyof typeof SchedulingStatus];

/**
 * Formata uma data para exibição legível
 */
export const formatScheduledDate = (date: string | null | undefined): string => {
 ...
 */
export const getTimeUntilScheduled = (scheduledAt: string | null | undefined): string => {
 ...
 */
export const getSuggestedSchedules = (): Array<{ label: string; date: string }> => {
  const now = new Date();
